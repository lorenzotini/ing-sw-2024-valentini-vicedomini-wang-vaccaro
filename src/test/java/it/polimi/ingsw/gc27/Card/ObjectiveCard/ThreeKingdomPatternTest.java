...
import it.polimi.ingsw.gc27.Model.Console;
...
class ThreeKingdomPatternTest {
    ...
    void calculateObjectivePoints() {
        ...
        */
        ...
        ObjectiveCard obj5=objectiveDeck.get(8); //triple fungi
        ObjectiveCard obj6=objectiveDeck.get(9);
        ...
        assertEquals(23, board.getPointsBluePlayer()+ obj5.calculateObjectivePoints(manuscript));
        assertEquals(21, board.getPointsBluePlayer()+ obj6.calculateObjectivePoints(manuscript));
